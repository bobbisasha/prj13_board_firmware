/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     UART ReadV1
  * - <b>Project file</b>:     C:/Users/user/Documents/Texas Instruments/Sensor Controller Studio/examples/uart_emulator_launchpad/uart_emulator_launchpad.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2026-04-18 11:28:11.395
  * - <b>Computer</b>:         HP-NOVAMEDIKACL
  * - <b>User</b>:             user
  *
  ...
  * UART read from DIO1 and DIO2. VDD supplied 100ms before reading on DIO5
  *
  *
  * \subsection section_io_mapping I/O Mapping
  * Task I/O functions are mapped to the following pins:
  * - UART Emulator:
  *     - <b>O: PowerSupply Sensor PIN</b>: DIO5
  *     - <b>UART RX</b>: DIO2
  *     - <b>UART TX</b>: DIO1
  *
  *
...
/// UART Emulator I/O mapping: PowerSupply Sensor PIN
#define SCIF_UART_EMULATOR_DIO_O_A02YYUW_VDDPIN 5
